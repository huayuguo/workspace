...
#define QEPO_GA_FILE                 "/data/misc/gps/QEPO_GA.DAT"
#define QEPO_GA_UPDATE_FILE          "/data/misc/gps/QEPOTMP_GA.DAT"
...
#define QEPO_GA_UPDATE_HAL           "/data/misc/gps/QEPO_GA_HAL.DAT"
