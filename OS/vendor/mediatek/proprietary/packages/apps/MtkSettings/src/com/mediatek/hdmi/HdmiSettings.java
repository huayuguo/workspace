...
public class HdmiSettings extends SettingsPreferenceFragment implements
    ...
    private static final String HDMI_VIDEO_RESOLUTION = "persist.sys.hdmi.resolution";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (HdimReflectionHelper.HDMI_BOX_SUPPORT){
    ...
    private void updatePrefStatus() {
        ...
        if (HdimReflectionHelper.HDMI_BOX_SUPPORT){
            hdmiEnabled = (SystemProperties.getInt("sys.hdmi.enable", 0) == 1);
        }
    ...
    private void updateSelectedResolution() {
        ...
        if (HdimReflectionHelper.HDMI_BOX_SUPPORT){
            ...
            autoVideoResolution = SystemProperties.getInt("persist.sys.hdmi.auto",13);
        }
        ...
        CharSequence[] resolutionEntries = mActivity.getResources().getStringArray(
                HdimReflectionHelper.HDMI_BOX_SUPPORT ? R.array.hdmi_box_video_resolution_entries :
        ...
        if (KEY_TOGGLE_HDMI.equals(key)) {
            ...
            if (HdimReflectionHelper.HDMI_BOX_SUPPORT){
                if (Integer.parseInt((String) newValue) ==
                    ...
                    SystemProperties.set("persist.sys.hdmi.auto","1");
                } else {
                    SystemProperties.set("persist.sys.hdmi.auto","0");
                }
            }
