...
public class SimDialogActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRCSExt = UtilsExt.getRCSSettingsExt(getApplicationContext());
        /// @}
        ...
        final DialogInterface.OnClickListener selectionListener =
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int value) {
                        ...
                        /// dialog show dual with CNOP plugin.
    ...
    private class SelectAccountListAdapter extends ArrayAdapter<String> {
        ...
        private void setPhoneAccountIcon(ViewHolder holder, int location) {
            ...
            if (!askFirst.equals(lableString)) {
                ...
                ////M: for ALPS03664730, PhoneAccountUtils in CtsVerifier does not add icon
