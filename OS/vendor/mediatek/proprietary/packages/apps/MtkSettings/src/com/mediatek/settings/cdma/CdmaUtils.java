...
public class CdmaUtils {
    ...
    public static boolean isCdmaCard(int slotId) {
        ...
        boolean isCdmaCard = (simType == CT_SIM || simType == C_G_SIM);
        Log.d(TAG, "isCdmaCardInserted simType = " + simType
    ...
    public static boolean isCdmaCardCompetion(Context context) {
        ...
        Log.d(TAG, "isCdmaCard: " + isCdmaCard + " isCompletition: " + isCompetition
                + " is Suppport SIM switch: " /*+ MtkFeatureOption.MTK_DISABLE_CAPABILITY_SWITCH*/);
        return isCdmaCard && isCompetition /*&& (!MtkFeatureOption.MTK_DISABLE_CAPABILITY_SWITCH)*/;
    }
