...
public class DevelopmentSettings extends RestrictedSettingsFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        /// M: usb preference change
        mDevExt = UtilsExt.getDevExt(getActivity());
    }
    ...
    public void onResume() {
        ...
        /// M: usb preference change
        Preference enableAdb = findPreference(mEnableAdbController.getPreferenceKey());
        mDevExt.customUSBPreference(enableAdb);
    }
    ...
    private boolean isSimLockedDevice() {
        ///@M: Return false directly on wifi-only device
