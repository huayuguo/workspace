...
public class StorageSettingsExts {
    ...
    private StorageRadioButtonPreference mDeafultWritePathPref;
    private StorageRadioButtonPreference[] mStorageWritePathList;
    ...
    private void updateDefaultWriteDiskCategory() {
        ...
        for (StorageVolume volume : availableVolumes) {
            StorageRadioButtonPreference preference =
                    new StorageRadioButtonPreference(mRoot.getPreferenceManager().getContext());
    ...
    private OnPreferenceChangeListener defaultWriteDiskListener = new OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            if (preference != null && preference instanceof StorageRadioButtonPreference) {
                ...
                mDeafultWritePathPref = (StorageRadioButtonPreference) preference;
                return true;
            }
            return false;
        }
