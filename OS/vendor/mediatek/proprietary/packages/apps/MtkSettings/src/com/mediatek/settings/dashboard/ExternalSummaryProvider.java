...
public class ExternalSummaryProvider {
    ...
    public static SummaryLoader.SummaryProvider createStubSummaryProvider(
            Activity activity, SummaryLoader summaryLoader, Tile tile) {
        if (tile.summary == null) {
            // Set summary as empty instead of null, avoid "summary_placeholder"
            tile.summary = activity.getString(com.android.settings.R.string.summary_empty);
        }
        return null;
    }
}
