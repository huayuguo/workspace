...
public final class SearchIndexableResources {
    ...
    static {
        ...
        addIndex(SearchExt.class, NO_DATA_RES_ID, R.drawable.ic_launcher_settings);
        /// M: Add NFC setting when NFC addon support @{
        addIndex(NfcSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_nfc_payment);
        /// @}
        addIndex(
