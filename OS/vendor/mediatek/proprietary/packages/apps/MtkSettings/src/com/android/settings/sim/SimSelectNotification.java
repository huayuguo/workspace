...
import com.mediatek.settings.sim.SimSelectService;
import com.mediatek.settings.sim.SimUtilJob;
...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_BOOT_COMPLETED.equals(action)) {
            ...
            // Do not create notifications on single SIM devices or
            //when provisioning i.e. Setup Wizard.
    ...
    private void handleBootCompleted(Context context) {
        ...
        SimUtilJob.scheduleJob(context);
        /*Intent intent = new Intent();
        intent.setClass(context, SimSelectService.class);
        Log.d(TAG, "Start None Service");
