...
import com.mediatek.settings.display.ClearMotionPreferenceController;
import com.mediatek.settings.display.CustomizeFontStylePreferenceController;
...
import com.mediatek.settings.display.CustomFontSizePreferenceController;
...
public class DisplaySettings extends DashboardFragment {
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
        ...
        /// M: Add ClearMotion settings preference @{
        controllers.add(new ClearMotionPreferenceController(context));
        /// @}
        ...
        /// @}
        /// M: Add lovelyfonts @{
        controllers.add(new CustomizeFontStylePreferenceController(context));
        /// @}
        /// M: add for HDMI settings
        controllers.add(new HdmiPreferenceController(context));
        /// M: add for OP18 Custom Font settings
        controllers.add(new CustomFontSizePreferenceController(context));
        /// @}
