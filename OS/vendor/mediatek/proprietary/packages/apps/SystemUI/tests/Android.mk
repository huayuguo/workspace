...
LOCAL_RESOURCE_DIR := $(LOCAL_PATH)/res \
    ...
    vendor/mediatek/proprietary/packages/apps/SystemUI/res-keyguard \
    vendor/mediatek/proprietary/packages/apps/SystemUI/res_ext \
    vendor/mediatek/proprietary/packages/apps/SystemUI/res-keyguard_ext \
    $(LOCAL_PATH)/res_ext
