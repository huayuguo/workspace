...
public class HighResThumbnailLoader implements TaskCallbacks {
    ...
    private static final String TAG = "HighResThumbnailLoader";
    ...
    /**
     * M: [ALPS03604674]Trim memory to avoid memory leak,
     * keep mVisibleTasks empty when recent activity hidden
     */
    public void onTrimMemory() {
       Log.d(TAG, "recent hidden, remove all task in mVisibleTasks");
       mVisibleTasks.clear();
    }
}
