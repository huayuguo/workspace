...
public class PowerOffAlarmManager {
    ...
    public PowerOffAlarmManager(Context context, ViewMediatorCallback viewMediatorCallback,
        ...
        mContext.sendBroadcast(new Intent(
                "android.intent.action.POWEROFF_ALARM_RECEIVER_READY"));

        Slog.d(TAG, "POWEROFF_ALARM_RECEIVER_READY broadcast sent");
    ...
    private static final String LAUNCH_PWROFF_ALARM =
            "mediatek.intent.action.LAUNCH_POWEROFF_ALARM";
