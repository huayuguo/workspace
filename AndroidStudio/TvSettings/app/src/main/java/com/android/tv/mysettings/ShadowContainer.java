...
public class ShadowContainer extends ViewGroup {
    ...
    public ShadowContainer(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        drawShadow = a.getBoolean(R.styleable.ShadowContainer_enable, false);
        a.recycle();
        mShadowPaint = new Paint();
        BlurMaskFilter maskFilter = new BlurMaskFilter(shadowRadius, BlurMaskFilter.Blur.OUTER);
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (drawShadow) {
            ...
            int left = child.getLeft() - 2;
            int top = child.getTop() - 2;
            int right = child.getRight() + 2;
    ...
    public void dispatchSetSelected(boolean selected) {
        ...
        setDrawShadow(selected);
        Log.e("ShadowContainer", "dispatchSetSelected: "  + selected);
    }
