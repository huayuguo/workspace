package com.huangchao.dashboardview;
...
public class DashboardView extends View {
    ...
    public DashboardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int colorForeground = array.getColor(1, Color.BLACK);
        int colorAccent = array.getColor(2, Color.BLACK);
        int textColor = array.getColor(3, Color.BLACK);
        array.recycle();
        ...
        mArcColor = a.getColor(R.styleable.DashboardView_arcColor, colorAccent);
        mMeasureTextSize = a.getDimensionPixelSize(R.styleable.DashboardView_measureTextSize, spToPx(12));
        mTextColor = a.getColor(R.styleable.DashboardView_textColor, textColor);
