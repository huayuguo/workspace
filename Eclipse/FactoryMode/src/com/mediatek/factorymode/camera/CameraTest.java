...
public class CameraTest extends Activity implements View.OnClickListener {
	...
	class CameraTest1 implements Camera.PictureCallback {
		public void onPictureTaken(byte[] paramArrayOfByte, Camera paramCamera) {

		}
	}

	class CameraTest2 implements SurfaceHolder.Callback {
    ...
    public static int getDisplayOrientation(int degrees, int cameraId) {
        ...
        Log.d("FactoryMode","info.orientation="+info.orientation);
        int result;
